...
export const translations = {
  zh: {
    ...
    'detail.notFound.subtitle': '这条内容可能已被删除，或者链接不正确。',
    'detail.notFound.cta': '去发现更多',
    ...
    'profile.delete.confirmTitle': '删除这个作品？',
    'profile.delete.confirmDesc': '「{title}」将被永久删除，且无法恢复。',
    'profile.delete.cancel': '取消',
    'profile.delete.confirm': '删除',
    'profile.delete.deleting': '删除中...',
    'profile.delete.toast': '已删除',
    'profile.delete.failed': '删除失败，请重试',
    ...
    'create.warning.hardcodedBlob': 'AI 在代码里写了临时的 blob: 链接，这些链接在预览/发布后都会失效。请在对话框里告诉它：「改用资源面板里『复制路径』得到的 ./assets/文件名 来引用图片」。',
    'create.unknownError': '未知错误',
    'create.workspace.title': '工作台',
    'create.workspace.remixTitle': 'Remix 工作台',
    'create.workspace.editTitle': '编辑作品',
    'create.workspace.publish': '发布 →',
    'create.workspace.save': '保存 →',
    ...
    'create.publish.headerEdit': '编辑作品',
    ...
    'create.publish.submitEdit': '保存修改',
    'create.publish.publishing': '正在发布...',
    'create.publish.saving': '正在保存...',
    'create.publish.success': '发布成功！',
    'create.publish.saved': '已保存',
  ...
  en: {
    ...
    'detail.notFound.subtitle': 'This piece may have been removed, or the link is wrong.',
    'detail.notFound.cta': 'Discover more',
    ...
    'profile.delete.confirmTitle': 'Delete this work?',
    'profile.delete.confirmDesc': '"{title}" will be permanently deleted and cannot be recovered.',
    'profile.delete.cancel': 'Cancel',
    'profile.delete.confirm': 'Delete',
    'profile.delete.deleting': 'Deleting...',
    'profile.delete.toast': 'Deleted',
    'profile.delete.failed': 'Delete failed, please retry',
    ...
    'create.warning.hardcodedBlob': 'The AI hardcoded temporary blob: URLs into the code — they will break in preview and after publishing. Tell it in the chat: "Use ./assets/<filename> (from the asset panel\'s Copy Path) instead."',
    'create.unknownError': 'Unknown error',
    'create.workspace.title': 'Workspace',
    'create.workspace.remixTitle': 'Remix workspace',
    'create.workspace.editTitle': 'Edit work',
    'create.workspace.publish': 'Publish →',
    'create.workspace.save': 'Save →',
    ...
    'create.publish.headerEdit': 'Edit work',
    ...
    'create.publish.submitEdit': 'Save changes',
    'create.publish.publishing': 'Publishing...',
    'create.publish.saving': 'Saving...',
    'create.publish.success': 'Published!',
    'create.publish.saved': 'Saved',
