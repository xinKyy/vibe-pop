...
export const translations = {
  zh: {
    ...
    'browse.categories.memory': '回忆',
    'browse.categories.generator': '生成器',
    ...
    'login.email': '邮箱地址',
    'login.emailPlaceholder': 'hello@example.com',
    'login.code': '验证码',
    'login.sendCode': '发送验证码',
    'login.devHint': '开发模式：输入验证码 000000 即可登录',
    'login.submit': '登录 / 注册',
  ...
  en: {
    ...
    'browse.categories.memory': 'Memories',
    'browse.categories.generator': 'Generators',
    ...
    'login.devHint': 'Dev mode: enter code 000000 to sign in',
